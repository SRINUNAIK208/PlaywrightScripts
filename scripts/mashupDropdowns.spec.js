    ...
    test.describe('mashup Test', () => {
        ...
        test('clickonuser',async ({ }) =>{
          ...
          await page.waitForTimeout(3000);
            ...
            await page.click(mashupElements.AllDropdown);
            await page.click(mashupElements.MyMashupButton);
            ...
            let AllinText=await page.$eval("sap-crm-form-field[class='col-xs--paddingright form-section-field']:nth-child(7) sap-crm-label",el => el.innerText);
            await console.log(" expected innerText " + inText);
            if(userName === AllinTextinText)
            {
            ...
            //await page.click(mashupElements.AllDropdown);
            //await page.click(mashupElements.AllButton);
        });
