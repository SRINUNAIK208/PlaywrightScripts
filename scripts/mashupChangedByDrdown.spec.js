...
let page;
    ...
    test.describe('mashup Test', () => {
        ...
        await page.waitForTimeout(3000);
        await page.click(mashupElements.changedByDropdown);
        await page.waitForTimeout(3000);
        await page.check(mashupElements.changedByUsernaCheckbox);
        await page.waitForTimeout(3000);
        ...
        let ChangedByinText=await page.$eval("sap-crm-form-field[class='col-xs--paddingright form-section-field']:nth-child(7) sap-crm-label",el => el.innerText);
        await console.log(" expected innerText " + inText);
        if(userName === ChangedByinText)
            {
