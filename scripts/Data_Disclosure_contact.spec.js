...
let page;
    ...
    test.describe('mashup Test', () => {
       ...
       test('Data Disclosure 1st msg', async ({ }) =>{
          test.setTimeout(90000);
          await page.click(mashupElements.SubjectTypeDropdown);
          await page.click(mashupElements.All_Contacts);
          ...
          await page.fill(mashupElements.DDSearchText, 'Dr. VasiKar02');
          ...
          await page.fill(mashupElements.searchDataSubjectType, 'Contact');
          await page.keyboard.press('Enter');
      ...
      /*test('Data Disclosure 2nd msg', async ({ }) =>{
        test.setTimeout(90000);
        await page.click(mashupElements.SubjectTypeDropdown);
        await page.click(mashupElements.All_Contacts);
        await page.click("sap-crm-button[text='2'] button");
          ...
          await page.waitForTimeout(3000);
          await page.click(mashupElements.DDsearIcon);
          await page.fill(mashupElements.DDSearchText, 'Frank Sent');
          await page.keyboard.press("Enter");
